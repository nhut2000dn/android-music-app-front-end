...
public class ChartsSongAdapter extends RecyclerView.Adapter<ChartsSongAdapter.RecyclerViewHolder>  {

  private List<Audio> mData;

  private ChartsSongAdapter.OnListenerRow mOnListenerRowSong;

  private ChartsSongAdapter.OnListenerMenuOption mOnListenerMenuOption;


  public ChartsSongAdapter(List<Audio> mData, ChartsSongAdapter.OnListenerRow onListenerRow, ChartsSongAdapter.OnListenerMenuOption onListenerMenuOption) {
    this.mData = mData;
  ...
  @NonNull
  @Override
  public ChartsSongAdapter.RecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    LayoutInflater inflater = LayoutInflater.from(parent.getContext());
    View view = inflater.inflate(R.layout.row_charts_song, parent, false);
    return new ChartsSongAdapter.RecyclerViewHolder(view, mOnListenerRowSong, mOnListenerMenuOption);
  }

  @SuppressLint("SetTextI18n")
  @Override
  public void onBindViewHolder(@NonNull ChartsSongAdapter.RecyclerViewHolder holder, int position) {
...
//            .fit().placeholder(R.drawable.playholder_music).into(holder.image);
  ...
  public class RecyclerViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    ChartsSongAdapter.OnListenerRow onListenerRowSong;

    ChartsSongAdapter.OnListenerMenuOption onListenerMenuOption;

    public RecyclerViewHolder(@NonNull View itemView, ChartsSongAdapter.OnListenerRow onListenerRowSong, ChartsSongAdapter.OnListenerMenuOption onListenerMenuOption) {
      super(itemView);
