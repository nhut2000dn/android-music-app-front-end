...
public class FilterSongAdapter extends RecyclerView.Adapter<FilterSongAdapter.RecyclerViewHolder> {

  private List<Audio> mData;

  private FilterSongAdapter.OnListenerRow mOnListenerRowSong;

  private FilterSongAdapter.OnListenerMenuOption mOnListenerMenuOption;


  public FilterSongAdapter(List<Audio> mData, FilterSongAdapter.OnListenerRow onListenerRow, FilterSongAdapter.OnListenerMenuOption onListenerMenuOption) {
    this.mData = mData;
  ...
  @NonNull
  @Override
  public FilterSongAdapter.RecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    LayoutInflater inflater = LayoutInflater.from(parent.getContext());
    View view = inflater.inflate(R.layout.row_song, parent, false);
    return new FilterSongAdapter.RecyclerViewHolder(view, mOnListenerRowSong, mOnListenerMenuOption);
  }

  @Override
  public void onBindViewHolder(@NonNull FilterSongAdapter.RecyclerViewHolder holder, int position) {
...
//            .fit().placeholder(R.drawable.playholder_music).into(holder.image);
  ...
  public class RecyclerViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    FilterSongAdapter.OnListenerRow onListenerRowSong;

    FilterSongAdapter.OnListenerMenuOption onListenerMenuOption;

    public RecyclerViewHolder(@NonNull View itemView, FilterSongAdapter.OnListenerRow onListenerRowSong, FilterSongAdapter.OnListenerMenuOption onListenerMenuOption) {
      super(itemView);
