...
public class PersonalPlaylistSongsAdapter extends RecyclerView.Adapter<PersonalPlaylistSongsAdapter.RecyclerViewHolder>  {

  private List<Audio> mData;

  private PersonalPlaylistSongsAdapter.OnListenerRow mOnListenerRowSong;

  private PersonalPlaylistSongsAdapter.OnListenerMenuOption mOnListenerMenuOption;


  public PersonalPlaylistSongsAdapter(List<Audio> mData, PersonalPlaylistSongsAdapter.OnListenerRow onListenerRow, PersonalPlaylistSongsAdapter.OnListenerMenuOption onListenerMenuOption) {
    this.mData = mData;
  ...
  @NonNull
  @Override
  public PersonalPlaylistSongsAdapter.RecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    LayoutInflater inflater = LayoutInflater.from(parent.getContext());
    View view = inflater.inflate(R.layout.row_song, parent, false);
    return new PersonalPlaylistSongsAdapter.RecyclerViewHolder(view, mOnListenerRowSong, mOnListenerMenuOption);
  }

  @Override
  public void onBindViewHolder(@NonNull PersonalPlaylistSongsAdapter.RecyclerViewHolder holder, int position) {
...
//            .fit().placeholder(R.drawable.playholder_music).into(holder.image);
  ...
  public class RecyclerViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    PersonalPlaylistSongsAdapter.OnListenerRow onListenerRowSong;

    PersonalPlaylistSongsAdapter.OnListenerMenuOption onListenerMenuOption;

    public RecyclerViewHolder(@NonNull View itemView, PersonalPlaylistSongsAdapter.OnListenerRow onListenerRowSong, PersonalPlaylistSongsAdapter.OnListenerMenuOption onListenerMenuOption) {
      super(itemView);
