...
public class PlaylistSongAdapter extends RecyclerView.Adapter<PlaylistSongAdapter.RecyclerViewHolder> {

  private List<Audio> mData;

  private PlaylistSongAdapter.OnListenerRow mOnListenerRowSong;

  private PlaylistSongAdapter.OnListenerMenuOption mOnListenerMenuOption;


  public PlaylistSongAdapter(List<Audio> mData, PlaylistSongAdapter.OnListenerRow onListenerRow, PlaylistSongAdapter.OnListenerMenuOption onListenerMenuOption) {
    this.mData = mData;
  ...
  @NonNull
  @Override
  public PlaylistSongAdapter.RecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    LayoutInflater inflater = LayoutInflater.from(parent.getContext());
    View view = inflater.inflate(R.layout.row_song, parent, false);
    return new PlaylistSongAdapter.RecyclerViewHolder(view, mOnListenerRowSong, mOnListenerMenuOption);
  }

  @Override
  public void onBindViewHolder(@NonNull PlaylistSongAdapter.RecyclerViewHolder holder, int position) {
...
//            .fit().placeholder(R.drawable.playholder_music).into(holder.image);
  ...
  public class RecyclerViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    PlaylistSongAdapter.OnListenerRow onListenerRowSong;

    PlaylistSongAdapter.OnListenerMenuOption onListenerMenuOption;

    public RecyclerViewHolder(@NonNull View itemView, PlaylistSongAdapter.OnListenerRow onListenerRowSong, PlaylistSongAdapter.OnListenerMenuOption onListenerMenuOption) {
      super(itemView);
